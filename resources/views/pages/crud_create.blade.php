    ...
    <div id="form_section_start" class="create_edit_box p-5">
        ...
        <form action="{{ route('comics.store') }}" method="POST" class="border border-5 border-info bg-light">
            ...
            <div class="form-group p-3 my-1">
                ...
                <input id="title_input" class="form-control" type="text" name="title" maxlength="100" placeholder="Please, enter the title, here!" required>
            </div>
            <div class="form-group p-3 my-1">
            ...
            <div class="d-flex justify-content-between">
                <div class="w-100">
                    ...
                    <div class="form-group w-100 p-3 my-1">
                        ...
                        <input id="serie_input" type="text" class="form-control" name="series" maxlength="50" placeholder="Enter the series, if you want...">
                    </div>
                    <div class="form-group w-100 p-3 my-1">
                        <label for="type_input" class="form-label text-primary fs-5">Type (REQUIRED):</label>
                        <input id="type_input" type="text" class="form-control" name="type" maxlength="50" placeholder="Comics type..." required>
                    </div>
                </div>
            ...
            <div class="d-flex">
                ...
                <div class="form-group p-3 my-1">
                    ...
                    <input id="price_input" type="number" class="form-control" name="price" min="0" max="99.99" step="0.1" required>
                </div>
            </div>
